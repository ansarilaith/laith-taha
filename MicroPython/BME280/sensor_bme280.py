...
class BME280:
    ...
    #         mode     xxxxxx00 = sample mode = sleep (for weather)
    #ctrl_meas      = 0b00101111 # for navigation
    ctrl_meas      = 0b00100100 # for weather
    ...
    # however, pressure should remain a similar value for the duration of a drone flight
    altitude_P = None
    ...
    def ok(self):
        try:
            if self.bus.read(self.address,0xD0,1) == [0x60]:
                print('BME Online')
                return True
